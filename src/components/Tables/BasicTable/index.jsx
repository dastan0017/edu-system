...
export const BasicTable = ({ data, openModal, tableColumns, keyField = 'id', ...props }) => {
  const intl = useIntl()
      ...
      {({ paginationProps, paginationTableProps }) => (
        <>
          <Row className="table_container">
            <BootstrapTable keyField={keyField} data={data} columns={tableColumns} {...paginationTableProps} {...props} />
          </Row>
